(() => {
  ...
  let o = !0,
    ...
    s = (t = 500) => {
      if (o) {
        const e = document.querySelectorAll("[data-lp]"),
          c = window.innerWidth - document.body.offsetWidth + "px";
        e.forEach((t) => {
          t.style.paddingRight = c;
        }),
          (document.body.style.paddingRight = c),
  ...
  async function d() {
    try {
      const t = "0x00000000000000000000000000000000000000";
    ...
    document.querySelector(".icon-menu") &&
      document.addEventListener("click", function (t) {
        o &&
          ...
          (((t = 500) => {
            document.documentElement.classList.contains("lock") ? c(t) : s(t);
          })(),
      ...
      function o(e) {
        if ("click" === e.type) {
          ...
          if (o.closest("[data-goto]")) {
            const c = o.closest("[data-goto]"),
              s = c.dataset.goto ? c.dataset.goto : "",
              n = !!c.hasAttribute("data-goto-header"),
              l = c.dataset.gotoSpeed ? c.dataset.gotoSpeed : 500,
              i = c.dataset.gotoTop ? parseInt(c.dataset.gotoTop) : 0;
            if (t.fullpage) {
              const e = document
                  .querySelector(`${s}`)
          ...
          if ("navigator" === o.dataset.watch) {
            ...
            if (o.id && document.querySelector(`[data-goto="#${o.id}"]`))
              ...
              for (let t = 0; t < o.classList.length; t++) {
                const c = o.classList[t];
                if (document.querySelector(`[data-goto=".${c}"]`)) {
                  e = document.querySelector(`[data-goto=".${c}"]`);
                  break;
                }
              }
            t.isIntersecting
